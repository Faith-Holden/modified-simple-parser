...
public class ModifiedSimpleParser3 {


    //    -------------------- Nested classes for Expression Trees ------------------------------

    // All the nested classes, including the abstract Expnode class, were edited to require a
    //double xVal as a parameter.
    /**
    ...
    //main was edited to provide the required parameters for the expression nodes.
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("\nValue is " + exp.value(0)+ " when x is 0.");
                System.out.println("\nValue is " + exp.value(1)+ " when x is 1.");
                System.out.println("\nValue is " + exp.value(2)+ " when x is 2.");
                System.out.println("\nValue is " + exp.value(3)+ " when x is 3.");
    ...
    //factorTree was edited to allow for variableNodes.
    /**
